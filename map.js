...
function initMap() {
    ...
    var contents = [
        ...
        ['Paczkomat InPost', '...', '<img class="placeImage" src="http://i.imgur.com/o1suqVD.jpg" />', infoWindowStyleLargePicture],
        ['Parking podziemny UEK', '...', '<img class="placeImage" src="http://i.imgur.com/tLC3Ldq.jpg" />', infoWindowStyleLargePicture],
        ...
        ['Boisko', '...', '<img class="placeImage" src="http://i.imgur.com/1kuSCOt.jpg" />', infoWindowStyleLargePicture],
        ['Kawka i mleczko', '...', '<img class="placeImage" src="http://i.imgur.com/tf00z0m.jpg" />', infoWindowStyleLargePicture],
        ['Parking pod Budynkiem Głównym', '...', '<img class="placeImage" src="http://i.imgur.com/u5laHyd.jpg" />', infoWindowStyleLargePicture],
