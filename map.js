...
function initMap() {
    ...
    var contents = [
        ...
        ['Pawilon B', '- mieści się pomiędzy pawilonem C oraz E. Posiada osobne wejście.', '<img class="placeImage" src="http://i.imgur.com/4TZylVo.png" />', infoWindowStyleLargePicture],
        ['Pawilon C', '- jest pawilonem, który posiada 7 sal wykładowych. Na poziomie -1 znajduje się szatnia, ksero, kawiarnia \"Kawka i mleczko\" oraz bar \"Pokusa\", a także siłownia.', '<img class="placeImage" src="http://ftppromocja.uek.krakow.pl/Zdjecia%20UEK/pawilon%20C/uek_pawilon_c_27.jpg" />', infoWindowStyleLargePicture],
        ['Pawilon D', '- mieszczą się w nim 4 sale wykładowe oraz 2 pracownie mikrobiologiczne.', '<img class="placeImage" src="http://i.imgur.com/jVBEcw9.jpg" />', infoWindowStyleLargePicture],
        ['Pawilon E', '- jest to niewielki pawilon, w którego skład wchodzą 3 salę wykładowe, mieści się pomiędzy pawilonem C oraz Biblioteką Główną.', '<img class="placeImage" src="http://i.imgur.com/GQmyqL2.jpg" />', infoWindowStyleLargePicture],
        ['Pawilon F', '- jest to pawilon Finansów. Na poziomie 0 znajduje się szatnia, ksero, bankomat przy wejściu, a także bar \"Bułka z makiem\". ', '<img class="placeImage" src="https://upload.wikimedia.org/wikipedia/commons/0/0d/Akademia_Ekonomiczna_w_Krakowie_Pawilon_F.JPG" />', infoWindowStyleLargePicture],
        ['Pawilon G', '- jest pawilonem 2 piętrowym. Na poziomie -1 znajduje się szatnia.', '<img class="placeImage" src="http://ftppromocja.uek.krakow.pl/wybrane_zdjecia_uek/Nowy%20Pawilon%20G%20UEK.jpg" />', infoWindowStyleLargePicture],
        ['Pawilon Ustronie', '- posiada 4 piętra, na dolnym piętrze znajduje się szatnia oraz stołówka.', '<img class="placeImage" src="http://ftppromocja.uek.krakow.pl/Zdjecia%20UEK/pawilon%20Ustronie/uek_pawilon_ustronie06.jpg" />', infoWindowStyleLargePicture],
        ['Pawilon Sportowo-dydaktyczny', '- jest pawilonem 2 piętrowym. Na poziomie 0 znajduje się szatnia oraz wejście na basen. Na poziomie -1 znajduje się hala sportowa oraz szatnie.', '<img class="placeImage" src="https://upload.wikimedia.org/wikipedia/commons/8/84/Akademia_Ekonomiczna_w_Krakowie_Basen.JPG" />', infoWindowStyleLargePicture],
        ...
        ['Przystanek tramwajowy Uniwersytet Ekonomiczny', '<br><br><a href="http://rozklady.mpk.krakow.pl/?lang=PL&akcja=przystanek&rozklad=20170513&przystanek=VW5pd2Vyc3l0ZXQgRWtvbm9taWN6bnkeEe" target="_blank">Rozkład jazdy</a>', '<img class="placeImage" src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/45/Znak_D-17.svg/820px-Znak_D-17.svg.png" />', infoWindowStyleVeryLargePicture],
        ['Budynek Główny', '- budynek w którym znajdują się m.in. dziekanaty, Dział Sprawy Bytowych Studentów i Doktorantów. Budynek Główny jest Siedzibą Władz Uczelni i Wydziałów oraz administracji centralnej i wydziałowej.  <h5>Historia</h5>Budynek pochodzący z końca XIX wieku (1893 rok), który początkowo pełnił rolę Schroniska dla Chłopców Księcia Aleksandra Lubomirskiego (funkcjonowało w latach 1893-1950). Schronisko miało przyjmować chłopców religii katolickiej z całej Galicji. Pierwotnie schronisko było przeznaczone na 120 osób, ale w wyniku dużego zapotrzebowania zwiększono je na 160 osób. W czasie I wojny światowej i tuż po niej w budynku funkcjonował szpital. W czasie II wojny światowej w budynku stacjonowały wojska niemieckie. Od 1952 roku właścicielem gmachu jest Uniwersytet Ekonomiczny w Krakowie, a budynek pełni funkcję gmachu reprezentacyjnego (tzw. budynek główny Uniwersytetu Ekonomicznego w Krakowie).', '<img class="placeImage" src="http://www.kpaz.uek.krakow.pl/wp-content/uploads/2014/04/g3.jpg" />', infoWindowStyleLargePicture],
        ['Pawilon Księżówka', '- w tym budynku znajduje się sala seminaryjna, a w podziemiach klub Grota.', '<img class="placeImage" src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/11/Akademia_Ekonomiczna_w_Krakowie_Pawilon_K_Ksiezowka.JPG/250px-Akademia_Ekonomiczna_w_Krakowie_Pawilon_K_Ksiezowka.JPG" />', infoWindowStyle],
        ['Klub Grota', '- mieście się w podziemiach budynku \"Księżówka\" blisko pawilonów G oraz D. ', '<img class="placeImage" src="http://i.imgur.com/ZgpTdlS.jpg" />', infoWindowStyleLargePicture],
        ['zaUEK', '- klub studencki, wejście do niego znajduje się od zewnątrz w pawilonie E. <br>Godziny otwarcia<br>poniedziałek-sobota: 8:00 - 22:00<br>niedziela: 8:00 - 16:00', '<img class="placeImage" src="http://i.imgur.com/oHoOqF5.jpg" />', infoWindowStyleLargePicture],
        ['Pokusa', '- bar mieszczący się na poziomie -1 pawilonu C.', '<img class="placeImage" src="http://i.imgur.com/kjlp1dN.jpg" />', infoWindowStyle],
        ['Bułka z makiem', '- bar mieści się na 0 poziomie w pawilonie F. Wejście do baru można bezpośrednio z pawilonu F lub z zewnątrz. <br>Godziny otwarcia:<br>poniedziałek–sobota: 8:00 – 19:00<br>niedziela: 8:00 – 16:00', '<img class="placeImage" src="http://i.imgur.com/baw8myl.jpg" />', infoWindowStyleLargePicture],
        ...
        ['Stróżówka', '- mieści się w rogu kampusu UEK, po prawej stronie od wejścia od ulicy Rakowickiej.', '<img class="placeImage" src="http://i.imgur.com/oIuRSUk.png" />', infoWindowStyleLargePicture],
        ['Paczkomat InPost', '- mieści się przy pawilonie G, blisko wyjazdu z terenu kampusu.', '<img class="placeImage" src="http://i.imgur.com/o1suqVD.jpg" />', infoWindowStyleLargePicture],
        ['Parking podziemny UEK', '- można dojechać do niego od strony aleji Pułkownika Władysława Beliny-Prażmowskiego', '<img class="placeImage" src="http://i.imgur.com/tLC3Ldq.jpg" />', infoWindowStyleLargePicture],
        ['SJO UEK', '- mieści się w pok 207 paw. Finansów.', '<img class="placeImage" src="https://cj.uek.krakow.pl/sjo_uek.jpg" />', infoWindowStyle],
        ['Wejście na UEK', 'od strony ulicy Aleksandra Lubomirskiego', '<img class="placeImage" src="http://i.imgur.com/qB7BCWX.jpg" />', infoWindowStyleLargePicture],
        ['Wejście na UEK', 'od strony ulicy Rakowickiej', '<img class="placeImage" src="http://i.imgur.com/U0qToNv.png" />', infoWindowStyleLargePicture],
        ['Wejście na UEK', 'od strony ulicy Rakowickiej', '<img class="placeImage" src="http://i.imgur.com/zDk1Iic.jpg" />', infoWindowStyleLargePicture],
        ['Wejście na UEK', 'od strony aleji Pułkownika Władysława Beliny-Prażmowskiego', '<img class="placeImage" src="http://i.imgur.com/5ZqZWAe.jpg" />', infoWindowStyleLargePicture],
        ['Stołówka', '- znajduje się w pawilonie Ustronie na poziomie 0.', '<img class="placeImage" src="http://ftppromocja.uek.krakow.pl/Zdjecia%20UEK/pawilon%20Ustronie/uek_pawilon_ustronie10.jpg" />', infoWindowStyleLargePicture],
        ['Boisko', '- znajduje się pomiędzy pawilonem Ustronie a Budynek Głównym. Jest często zajęte przez rozkładane namioty związane z różnymi wydarzeniami na UEK.', '<img class="placeImage" src="http://i.imgur.com/1kuSCOt.jpg" />', infoWindowStyleLargePicture],
